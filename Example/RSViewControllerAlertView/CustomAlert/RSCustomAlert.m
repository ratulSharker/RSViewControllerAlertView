...
@interface RSCustomAlert () <UITableViewDataSource, UITableViewDelegate>

@end

@implementation RSCustomAlert
{
...
-(IBAction)onDismissPressed:(id)sender
{
    ...
    //
    [self hideWithAnimation:PredefinedAnimation_HideWithDamping onComplete:nil];
}
